 ...
 * @LastEditors: 李淳
 * @LastEditTime: 2020-07-20 16:47:12
...
| -----------| --------------| --------------|--------------|
| 构建工具   | cosmos-builder-webpack           | https://www.npmjs.com/package/cosmos-builder-webpack |  何波、尚万郑、董方旭、李清清        |
| 静态代码规范   | eslint-config-sf-cosmos       | http://10.188.40.249/-/web/detail/eslint-config-sf-cosmos|  任亚楠   |
