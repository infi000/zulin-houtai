...
export const getDel = createServiceAsyncThunk(
  `${NAMESPACE}/getDel`,
  async (params: {tbid: number}) => services.getDelService(params),
);

export const getDataDetail = createServiceAsyncThunk(
  `${NAMESPACE}/getDataDetail`,
  async (params: {tbid: number, type: any}) => services.getDataDetailService({ tbid: params.tbid }),
);


export const getOnline = createServiceAsyncThunk(
  `${NAMESPACE}/getOnline`,
  async (params: {tbid: number}) => services.getOnlineService(params),
);
