...
export const getDataListService = (params: TSearchParams & IPagination) =>
  getRequest<TSearchParams & IPagination, IListResponse<ITableItem>>('/Lease/experimentcategorys', formatPage(params));

// 新建
export const postCreateService = (params: TCreateParams) =>
  postFormDataRequest<TCreateParams, IResponseData<string>>('/Lease/experimentcategoryadd', params);

// 编辑
export const postEditService = (params: TModifyParams) =>
  postFormDataRequest<TModifyParams, IResponseData<string>>('/Lease/experimentcategorymodify', params);
...
export const getDelService = (params: { eid: number }) =>
  postRequest<{ eid: number }, IResponseData<string>>('/Lease/experimentcategorydelete', params);
// 上线
...
export const getDataDetailService = (params: { eid: number }) =>
  getRequest<{ eid: number }, IResponseData<ITableItem>>('/Lease/experimentcategorydetail', params);
