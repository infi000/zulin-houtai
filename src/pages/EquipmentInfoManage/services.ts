...
// 获取成本中心地址
export const getCostCenterAddrService = (params: { costCenterCode: string }) =>
  getRequest<{ costCenterCode: string }, IResponseData<string>>(
    '/tsResource/common/getCostCenterAddress',
    params,
  );
