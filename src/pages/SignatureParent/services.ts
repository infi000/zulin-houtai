 ...
 * @LastEditTime: 2023-09-09 17:45:22
...
export const postUploadbase64 = (params: any) => postFormDataRequestWx<any>('/User/uploadbase64', params);
export const postAgreement = (params: any) => postFormDataRequestWx<any>('/User/agreement', params);

// 获取列表
export const getRegisterInfo = (params: any) => postFormDataRequestWx<any>('/User/registerinfo', params);
