 ...
 * @LastEditTime: 2023-09-09 17:22:38
...
import { postUploadbase64 } from './services';
...
const Signature = () => {
  ...
  const confirmSign = () => {
    ...
    postUploadbase64({ data: base, openid }).then((res:any) => {
      console.log(res);
      if (res.res === 'succ') {
        const searchParams = window.location.search;
        window.location.href = `/uiResources/blank/wordApp${searchParams}&agreement=${JSON.stringify({ regusersign: res.data, reguserguardiansign: res.data, safeuserguardiansign: res.data, safeusersign: res.data })}&type=create`;
      } else {
