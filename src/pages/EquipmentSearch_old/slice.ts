...
export const postStatistic = createServiceAsyncThunk(
  `${NAMESPACE}/postStatistic`,
  async () => services.postStatisticService(),
);
...
const slice = createSlice({
  ...
  extraReducers: builder => {
    ...
    builder.addCase(postStatistic.fulfilled, state => {
      state.refresh += 1;
    });
  },
});
