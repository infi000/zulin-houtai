...
export const postOrderverification = createServiceAsyncThunk(
  `${NAMESPACE}/postOrderverification`,
  async (params:any) => services.postOrderverificationService(params),
);
...
const slice = createSlice({
  ...
  extraReducers: builder => {
    ...
    builder.addCase(postOrderverification.fulfilled, state => {
