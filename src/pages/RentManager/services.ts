 ...
 * @LastEditTime: 2024-01-07 00:36:39
...
export const getDataListService = (params: TSearchParams & IPagination) =>
  getRequest<TSearchParams & IPagination, IListResponse<ITableItem>>('/Shop/zlorders', formatPage(params));
...
// 核销
export const postOrderverificationService = (params:any) =>
  postRequest<any, IResponseData<string>>('/Shop/orderverification', params);
