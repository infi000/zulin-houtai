 ...
 * @LastEditTime: 2023-05-30 19:18:48
...
function CreateModule() {
  ...
  const handleCostCenterChange = (e:any, row: any) => {
    form.setFieldsValue({ inCostCenterDescription: row?.children });
  };
