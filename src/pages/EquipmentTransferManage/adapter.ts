 ...
 * @LastEditTime: 2023-05-30 19:07:40
...
export const formatSearchParams = (params: any) => {
  ...
  let f_dispatchEndTime;
  let f_dispatchStartTime;
  if (dispatchMonth) {
    f_dispatchEndTime = ([...dispatchMonth][1] as any).format('YYYY-MM'); // 调拨年月日期
    f_dispatchStartTime = ([...dispatchMonth][0] as any).format('YYYY-MM'); // 调拨年月日期
  }
  let f_submitEndTime;
  ...
  return {
    ...rest,
    dispatchEndTime: f_dispatchEndTime, // 调拨年月
    dispatchStartTime: f_dispatchStartTime, // 调拨年月
